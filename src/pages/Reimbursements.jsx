      ...
      <div style={{ padding: '22px 18px 14px', borderBottom: '0.5px solid var(--border-light)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          {(fullName || volunteer['Address']) && (
            <div style={{ border: '0.5px solid var(--border)', borderRadius: 10, padding: '8px 12px', marginBottom: 8 }}>
              <div style={{ fontSize: 10, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: 0.6, fontWeight: 500, marginBottom: 3 }}>
                Sent to
              </div>
