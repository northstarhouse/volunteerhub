    ...
    >
      ...
      {expanded && (
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: '0.5px solid var(--border-light)' }}>
          ...
          {vol['Emergency Contact'] && (
            <div style={{ marginBottom: 8 }}>
              <div className="label">Emergency Contact</div>
              <div style={{ fontSize: 12, color: 'var(--text)', lineHeight: 1.6 }}>{vol['Emergency Contact']}</div>
            </div>
          )}
  ...
  return (
    <div>
      ...
      <div style={{ padding: '22px 18px 14px', borderBottom: '0.5px solid var(--border-light)', background: '#fff' }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 700, fontFamily: "'Cardo','Georgia',serif", color: 'var(--gold)' }}>Volunteer Directory</div>
      </div>
