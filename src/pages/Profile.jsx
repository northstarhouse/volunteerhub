          ...
          <>
            ...
            <div className="card" style={{ marginBottom: 14 }}>
              ...
              <ViewRow label="Birthday" value={fmtBirthday(vol['Birthday']) && (
                <>{fmtBirthday(vol['Birthday'])}{birthdayZodiac(vol['Birthday']) && <span style={{ color: 'var(--muted)' }}> · <span style={{ color: 'var(--gold)' }}>{birthdayZodiac(vol['Birthday']).symbol}</span> {birthdayZodiac(vol['Birthday']).name}</span>}</>
              )} onEdit={startEdit} />
